    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/ncat-hw-comp',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'GroupMe',
                href: 'https://groupme.com/join_group/69468075/75DN5wIv',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} North Carolina A&T University`,
      },
      prism: {
